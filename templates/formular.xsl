            ...
            <div id="wrapper">
                <header>
                    ...
                    <form class="form-horizontal" action="/processForm.php" method="post">
                        ...
                        <div class="form-group">
                            <label for="id" class="col-md-2 control-label">Anrede</label>
                            <div class="col-xs-3">
                                <span class="input-group-btn">
                                    <select class="form-control" name="anrede" id="anrede">
                                        <option>
                                            <xsl:if test="//form/field[@name='anrede']/herr = 'selected'">
                                                <xsl:attribute name="selected">selected</xsl:attribute></xsl:if>
                                            Herr</option>
                                        <option>
                                            <xsl:if test="//form/field[@name='anrede']/frau = 'selected'">
                                                <xsl:attribute name="selected">selected</xsl:attribute></xsl:if>
                                            Frau</option>
                                    </select>
                                </span>
